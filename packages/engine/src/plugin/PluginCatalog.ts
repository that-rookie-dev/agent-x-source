...
const BUILTIN_PLUGINS: PluginHubEntry[] = [
  {
    ...
    name: 'PostgreSQL',
    version: '1.0.0',
    description: 'Use PostgreSQL as external database for sessions and persistent storage. Scales beyond local SQLite with concurrent access, role-based auth, and cloud deployment support.',
    author: 'Agent-X',
  ...
  },
  {
    ...
    name: 'SQLite Browser',
    version: '1.0.0',
    description: 'Browse and manage the local SQLite database through the web UI. View sessions, messages, and token usage statistics.',
    author: 'Agent-X',
    category: 'database',
    tags: ['database', 'sqlite', 'admin', 'debug'],
    isBuiltin: true,
    config: {
      readOnly: {
        type: 'boolean',
        label: 'Read-only mode',
        description: 'Prevent accidental data modification',
        default: true,
      },
    },
  },
