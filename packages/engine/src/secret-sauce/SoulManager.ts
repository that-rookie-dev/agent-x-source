...
## Memory
You have a persistent memory system. Information in [MEMORIES] was remembered from previous sessions. Always use these memories to personalize responses — address the user by name if known, apply their preferences, and reference their context. If the user corrects you about something personal (name, preferences, role), acknowledge it naturally.
`;
