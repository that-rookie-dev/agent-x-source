...
export const DEFAULT_TOOL_DISPLAY: Record<string, ToolDisplaySpec> = {
  ...
  automation_register: { icon: '⏰', label: 'Automation', color: '#FFB74D' },
  automation_confirm: { icon: '✅', label: 'Confirm', color: '#81C784' },
  automation_list: { icon: '📋', label: 'Automations', color: '#4FC3F7' },
  automation_cancel: { icon: '🛑', label: 'Cancel', color: '#E57373' },
