...
import { createProcessesRouter } from './legacy/processes.js';
import { createTerminalsRouter } from './legacy/terminals.js';
import { createEngineeringCrewRouter } from './legacy/engineering-crew.js';
...
export function router(ctx: ApiContext): Router {
  ...
  r.use(createProcessesRouter());
  r.use(createTerminalsRouter());
  r.use(createEngineeringCrewRouter());
