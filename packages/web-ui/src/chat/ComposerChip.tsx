...
import { MENTION_TOKEN_SPLIT_RE, parseCrewMentionToken, parseFileMentionToken, parseFolderMentionToken } from './mention-tokens';
...
/** Tokens for @file[…], @folder[…], @crew[…], and legacy colon / bare @callsign. */
