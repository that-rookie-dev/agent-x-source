...
export const settingsBtnPrimarySx: SxProps<Theme> = {
  ...
  minHeight: 28,
  boxShadow: 'none',
  '&:hover': { bgcolor: settingsTheme.accent.hud, borderColor: settingsTheme.accent.hud, opacity: 0.92 },
  '&:disabled': { bgcolor: settingsTheme.border.default, borderColor: settingsTheme.border.default, color: settingsTheme.text.dim },
};
...
export const settingsBtnGhostSx: SxProps<Theme> = {
  ...
  letterSpacing: '0.5px',
  textTransform: 'uppercase',
  border: `1px solid ${alphaColor(settingsTheme.accent.hud, '55')}`,
  ...
  '&:disabled': { borderColor: settingsTheme.border.default, color: settingsTheme.text.dim },
};
